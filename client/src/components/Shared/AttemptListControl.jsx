...
const AttemptListControls = ({ viewMode, onToggleView, sortBy, sortDirection, onSortChange }) => {
    ...
    // Updated sort options for quiz attempts
    const sortOptions = [
        { value: 'studentName', label: 'A-Z' },
        { value: 'quizTitle', label: 'Quiz Title' },
...
export default AttemptListControls;