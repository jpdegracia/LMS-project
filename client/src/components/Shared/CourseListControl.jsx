// src/components/Shared/CourseListControls.jsx
import React from 'react';
import { LayoutGrid, List, ArrowUp, ArrowDown } from 'lucide-react';

const CourseListControls = ({ viewMode, onToggleView, sortBy, sortDirection, onSortChange }) => {
  ...
  const sortOptions = [
    ...
    { value: 'enrollmentDate', label: 'Enrolled On' },
    ...
    <div className="flex items-center space-x-2">
      ...
      <div className="flex items-center space-x-1 p-1 rounded-md bg-gray-200">
        ...
        <button
          ...
          className={`p-2 rounded-md transition-colors duration-200 ${
            viewMode === 'table' ? 'bg-blue-600 text-white shadow-sm' : 'text-gray-700 hover:bg-gray-300'
          }`}
          title="Table View"
        >
          <List size={20} />
